...
public interface ICosmosListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterIndex([NotNull] Cosmos.IndexContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="Cosmos.index"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitIndex([NotNull] Cosmos.IndexContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterPi([NotNull] Cosmos.PiContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="Cosmos.pi"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitPi([NotNull] Cosmos.PiContext context);
	/// <summary>
